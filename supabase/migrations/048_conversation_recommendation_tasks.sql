...
begin
  ...
  values('conversation_recommendation_task_created','conversation_recommendation',v_rec.id::text,p_actor_id,jsonb_build_object('task_id',v_task_id,'contact_id',v_rec.contact_id,'reply_id',v_rec.reply_id));
