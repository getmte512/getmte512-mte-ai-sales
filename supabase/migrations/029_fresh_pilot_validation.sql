...
begin
  ...
  values('pilot_account_status_updated','pilot_account',p_id::text,p_actor_id,jsonb_build_object('status',p_status,'contact_id',v_account.contact_id,'feedback_notes',v_account.feedback_notes,'launch_smoke_checked_at',v_smoke_checked_at));
