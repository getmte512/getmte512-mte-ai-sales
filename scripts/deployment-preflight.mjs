...
const evidenceSecret=String(env.REVIEW_EVIDENCE_SIGNING_SECRET??"");const evidenceKeyId=String(env.REVIEW_EVIDENCE_SIGNING_KEY_ID??"primary");check("Review evidence signing",!production||(evidenceSecret.length>=32&&/^[A-Za-z0-9._-]{1,64}$/.test(evidenceKeyId)),production?"A server-only evidence signing secret of at least 32 characters and a valid key ID are required.":"Evidence signing is required for production exports.");
