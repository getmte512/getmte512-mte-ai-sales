export type LeadScoringInput = { buyer_name:string|null; job_title:string|null; email:string|null; phone:string|null; linkedin_url?:string|null; website?:string|null; category:string|null; state:string|null; notes?:string|null; completeness:string; email_health:string };
